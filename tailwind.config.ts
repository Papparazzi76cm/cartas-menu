  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        menu: {
          bg: "hsl(var(--menu-bg))",
          title: "hsl(var(--menu-title))",
          subtitle: "hsl(var(--menu-subtitle))",
          body: "hsl(var(--menu-body))",
          price: "hsl(var(--menu-price))",
          description: "hsl(var(--menu-description))",
          divider: "hsl(var(--menu-divider))",
          allergen: { bg: "hsl(var(--menu-allergen-bg))", text: "hsl(var(--menu-allergen-text))" },
          tag: { bg: "hsl(var(--menu-tag-bg))", text: "hsl(var(--menu-tag-text))" },
          ornament: "hsl(var(--menu-ornament))",
        },
        editor: {
